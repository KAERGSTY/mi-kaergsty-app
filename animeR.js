...
window.base["Rock wa Lady no Tashinami deshite"] = {
    carpeta: "imgR",
    nombresAlternativos: {
        "Japonés": "ロックは淑女の嗜みでして",
        "Ingles": "Rock Is a Lady's Modesty"
    },
...
window.base["Ryza no Atelier"] = {
    carpeta: "imgR",
    nombresAlternativos: {
        "Japonés": "ライザのアトリエ 〜常闇の女王と秘密の隠れ家〜",
        "Ingles": "Atelier Ryza: Ever Darkness & the Secret Hideout"
    },
...
window.base["Rokudenashi Majutsu Koushi to Akashic Records"] = {
    carpeta: "imgR",
    nombresAlternativos: {
        "Japonés": "ロクでなし魔術講師と禁忌教典",
        "Ingles": "Akashic Records of Bastard Magic Instructor"
    },
...
window.base["Rougo ni Sonaete Isekai de 8-manmai no Kinka"] = {
    carpeta: "imgR",
    nombresAlternativos: {
        "Japonés": "老後に備えて異世界で８万枚の金貨を貯めます",
        "Ingles": "Saving 80,000 Gold in Another World for My Retirement"
    },
